        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              ...
              acompanhamento profissional dedicado. Nossa missão é ajudar
              você a alcançar seus objetivos de saúde de forma sustentável.
            </p>
            <div className="flex space-x-4">
              <a 
                href="https://instagram.com/avantenutris" 
                target="_blank" 
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/#planos" className="text-gray-400 hover:text-green-400 transition-colors">
                  Planos
                </Link>
              </li>
              <li>
