      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
          {cards.map((card) => (
            <Card
              key={card.id}
              className={`flex flex-col h-full relative border border-green-200 transition-all duration-300 hover:transform hover:scale-105 ${
                card.id === "avaliacao" ? "shadow-xl border-emerald-500" : ""
              }`}
            >
              {card.id === "avaliacao" && (
              ...
              <div className="p-8 flex-1 flex flex-col">
                <div className="text-center mb-6">
                  <h3 className="font-bold text-2xl text-green-800 mb-1">
                    {card.title}
                  </h3>
                  {card.subtitle && (
                ...
                {card.cta && (
                  <div className="mt-auto">
                    <Link to="/pricing" className="block w-full">
                      <Button
                        className="w-full py-3 bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white"                        
                        noFocus
                      >
