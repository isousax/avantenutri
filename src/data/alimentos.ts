...
export const CATEGORIAS_ALIMENTOS = [
  "Frutas", "Pratos & Preparações", "Lanches & Snacks", "Doces & Açúcares", "Verduras & Legumes", "Cereais & Grãos", "Bebidas", "Leguminosas", "Carnes & Peixes", "Ovos & Laticínios", "Óleos & Gorduras", "Sementes & Oleaginosas", 
] as const;
...
export const ALIMENTOS: Alimento[] = [
  ...
  {id: "abacate", nome: "Abacate", categoria: "Frutas", emoji: "🥑", calorias: 160,proteina: 2.0,carboidratos: 9,gordura: 15,porcaoPadrao: 100,porcaoDescricao: "1 unidade média"},
  ...
  {id: "cenoura", nome: "Cenoura Crua", categoria: "Verduras & Legumes", emoji: "🥕", calorias: 41,proteina: 0.9,carboidratos: 10,gordura: 0.2,porcaoPadrao: 100,porcaoDescricao: "1 unidade média",},
  {id: "cenoura_cozida", nome: "Cenoura Cozida", categoria: "Verduras & Legumes", emoji: "🥕", calorias: 35,proteina: 0.8,carboidratos: 8,gordura: 0.2,porcaoPadrao: 100,porcaoDescricao: "1 unidade média",},
  ...
  {id: "beterraba_crua", nome: "Beterraba Crua", categoria: "Verduras & Legumes", emoji: "🥗", calorias: 43,proteina: 1.6, carboidratos: 10, gordura: 0.2, porcaoPadrao: 100, porcaoDescricao: "1 unidade média"},
  {id: "beterraba_cozida", nome: "Beterraba Cozida", categoria: "Verduras & Legumes", emoji: "🍲", calorias: 44, proteina: 1.7, carboidratos: 10, gordura: 0.2, porcaoPadrao: 100, porcaoDescricao: "2 fatias grandes"},
  ...
  {id: "feijao_macassa", nome: "Feijão Macassa (cozido)", categoria: "Leguminosas", emoji: "🫘", calorias: 116,proteina: 8.0,carboidratos: 21,gordura: 0.5,porcaoPadrao: 100,porcaoDescricao: "½ xícara",},
  {id: "feijao_branco", nome: "Feijão Branco (cozido)", categoria: "Leguminosas", emoji: "⚪", calorias: 139,proteina: 9.7,carboidratos: 25,gordura: 0.4,porcaoPadrao: 100,porcaoDescricao: "½ xícara",},
  {id: "feijao_vermelho", nome: "Feijão Vermelho (cozido)", categoria: "Leguminosas", emoji: "🔴", calorias: 127,proteina: 8.7,carboidratos: 23,gordura: 0.5,porcaoPadrao: 100,porcaoDescricao: "½ xícara",},
  {id: "grao_de_bico", nome: "Grão-de-Bico (cozido)", categoria: "Leguminosas", emoji: "🧆", calorias: 164,proteina: 8.9,carboidratos: 27,gordura: 2.6,porcaoPadrao: 100,porcaoDescricao: "½ xícara",},
  {id: "lentilha", nome: "Lentilha (cozida)", categoria: "Leguminosas", emoji: "🥣", calorias: 116,proteina: 9.0,carboidratos: 20,gordura: 0.4,porcaoPadrao: 100,porcaoDescricao: "½ xícara",},
  ...
  {id: "charque_cozida_magra", nome: "Charque (dessalgada/cozida) - Só Magra", categoria: "Carnes & Peixes", emoji: "🥩", calorias: 263,proteina: 35.0,carboidratos: 0.0,gordura: 13.0,porcaoPadrao: 100,porcaoDescricao: "1 porção média",},
  {id: "charque_cozida_gorda", nome: "Charque (dessalgada/cozida) - Com Gordura", categoria: "Carnes & Peixes", emoji: "🥓", calorias: 380,proteina: 28.0,carboidratos: 0.0,gordura: 30.0,porcaoPadrao: 100,porcaoDescricao: "1 porção média",},
  {id: "charque_frita", nome: "Charque Frita (em óleo/banha)", categoria: "Carnes & Peixes", emoji: "🍳", calorias: 450,proteina: 32.0,carboidratos: 0.0,gordura: 36.0,porcaoPadrao: 100,porcaoDescricao: "1 porção média",},
  ...
  {id: "iogurte_natural_inteiro", nome: "Iogurte Natural Inteiro", categoria: "Ovos & Laticínios", emoji: "🥛", calorias: 61,proteina: 3.5,carboidratos: 4.7,gordura: 3.3,porcaoPadrao: 100,porcaoDescricao: "1/2 copo",},
  {id: "iogurte_natural_desnatado", nome: "Iogurte Natural Desnatado", categoria: "Ovos & Laticínios", emoji: "🥛", calorias: 41,proteina: 3.8,carboidratos: 5.0,gordura: 0.3,porcaoPadrao: 100,porcaoDescricao: "1/2 copo",},
  {id: "iogurte_grego_tradicional", nome: "Iogurte Grego Tradicional", categoria: "Ovos & Laticínios", emoji: "🍦", calorias: 113,proteina: 4.6,carboidratos: 15,gordura: 4.0,porcaoPadrao: 100,porcaoDescricao: "1 unidade",},
  {id: "iogurte_grego_zero", nome: "Iogurte Grego Zero Açúcar", categoria: "Ovos & Laticínios", emoji: "🍦", calorias: 55,proteina: 7.0,carboidratos: 6.0,gordura: 0.0,porcaoPadrao: 100,porcaoDescricao: "1 unidade",},
  {id: "iogurte_frutas_morango", nome: "Iogurte com Frutas (Morango)", categoria: "Ovos & Laticínios", emoji: "🍓", calorias: 95,proteina: 2.8,carboidratos: 16,gordura: 2.2,porcaoPadrao: 100,porcaoDescricao: "1 unidade",},
  {id: "iogurte_proteico_whey", nome: "Iogurte Proteico (Tipo Whey)", categoria: "Ovos & Laticínios", emoji: "💪", calorias: 65,proteina: 11,carboidratos: 5.0,gordura: 0.0,porcaoPadrao: 100,porcaoDescricao: "1/2 garrafa",},
  {id: "iogurte_kefir_natural", nome: "Kefir de Leite Natural", categoria: "Ovos & Laticínios", emoji: "🍶", calorias: 37,proteina: 3.0,carboidratos: 4.8,gordura: 0.6,porcaoPadrao: 100,porcaoDescricao: "1/2 copo",},
...
export function buscarAlimentos(termo: string): Alimento[] {
  ...
  return ALIMENTOS.filter((alimento) =>  alimento.nome.toLowerCase().includes(termoLimpo) ||  alimento.categoria.toLowerCase().includes(termoLimpo) ||  alimento.id.toLowerCase().includes(termoLimpo) ||  alimento.emoji.toLowerCase().includes(termoLimpo) ||  alimento.porcaoDescricao.toLowerCase().includes(termoLimpo),
  );
}
...
export function calcularNutricao(
  ...
  return {calorias: Math.round(alimento.calorias * fator),proteina: +(alimento.proteina * fator).toFixed(1),carboidratos: +(alimento.carboidratos * fator).toFixed(1),gordura: +(alimento.gordura * fator).toFixed(1),
  };
}
