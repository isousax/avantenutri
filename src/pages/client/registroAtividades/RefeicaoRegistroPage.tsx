...
const RefeicaoRegistroPage: React.FC = () => {
  ...
  const [gCarb, setGCarb] = useState(metasFinais.carboidratos?.toString()||'');
  ...
  const [alimentosSelecionados, setAlimentosSelecionados] = useState<Array<{
    alimento: Alimento;
    quantidade: number;
  ...
  // Calcular estatísticas a partir dos dados dos logs
  const stats = useMemo(() => {
  ...
  // Calcular progresso baseado nas metas finais
  const progress = useMemo(() => {
    ...
    return {
      calories: metasFinais.calorias ? Math.round((todayTotals.calories / metasFinais.calorias) * 100) : null,
      protein_g: metasFinais.proteina ? Math.round((todayTotals.protein / metasFinais.proteina) * 100) : null,
      carbs_g: metasFinais.carboidratos ? Math.round((todayTotals.carbs / metasFinais.carboidratos) * 100) : null,
      fat_g: metasFinais.gordura ? Math.round((todayTotals.fat / metasFinais.gordura) * 100) : null
    };
  }, [logs, metasFinais]);
  ...
  const calcularTotalNutricao = () => {
    return alimentosSelecionados.reduce((total, item) => ({
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      // Criar descrição baseada nos alimentos selecionados
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50/30 to-red-50 safe-area-bottom">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="p-5">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Adicione os alimentos consumidos</p>
              </div>
            </div>
            ...
            <form onSubmit={submit} className="space-y-6">
              ...
              <div>
                ...
                >
                  {mealTypes.map(m => (
                    <option key={m} value={m}>{t(`meal.type.${m}`)}</option>
                  ))}
                </select>
              </div>
              ...
              <div>
                ...
                {alimentosSelecionados.length === 0 ? (
                  <div className="bg-gray-50 rounded-xl p-8 text-center border-2 border-dashed border-gray-300">
                    ...
                    <p className="text-gray-500 font-medium">Nenhum alimento adicionado</p>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center">
                              <span className="text-lg">{item.alimento.emoji}</span>
                            </div>
                            <div className="min-w-0 flex-1">
                              <div className="font-semibold text-gray-800 truncate">{item.alimento.nome}</div>
                          ...
                          <div className="flex items-center gap-4">
                            <div className="text-right text-sm hidden sm:block">
                              <div className="font-medium text-orange-700">{item.nutricao.calorias} kcal</div>
                              <div className="text-gray-600 text-xs">
                                P:{item.nutricao.proteina}g • C:{item.nutricao.carboidratos}g • G:{item.nutricao.gordura}g
                              </div>
                            </div>
                            <button
                              type="button"
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                          <div className="text-center">
                            <div className="font-bold text-orange-700">{totalNutricao.calorias}</div>
                            <div className="text-xs text-gray-600">kcal</div>
                          </div>
                          <div className="text-center">
                            <div className="font-bold text-green-700">{totalNutricao.proteina.toFixed(1)}</div>
                            <div className="text-xs text-gray-600">Proteína</div>
                          </div>
                          <div className="text-center">
                            <div className="font-bold text-blue-700">{totalNutricao.carboidratos.toFixed(1)}</div>
                            <div className="text-xs text-gray-600">Carboidratos</div>
                          </div>
                          <div className="text-center">
                            <div className="font-bold text-purple-700">{totalNutricao.gordura.toFixed(1)}</div>
        ...
        {/* Estatísticas e Metas modernizadas */}
        <Card className="bg-white border-0 shadow-lg rounded-2xl overflow-hidden">
          <div className="p-5">
            <div className="flex items-center gap-3 mb-6">
            ...
            {editingGoals && (
              <div className="bg-blue-50 rounded-xl p-4 mb-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Calorias (kcal)</label>
                    <input 
                      value={gCal} 
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Proteína (g)</label>
                    <input 
                      value={gProt} 
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Carboidratos (g)</label>
                    <input 
                      value={gCarb} 
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Gordura (g)</label>
                    <input 
                      value={gFat} 
            ...
            {stats ? (
              <>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 mb-6">
                  <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-4 border border-orange-200">
                    <div className="text-xs font-semibold text-gray-700 mb-1">Calorias Total</div>
                    <div className="text-lg font-bold text-orange-700">{formatNumber(stats.totalCalories, locale)}</div>
                  </div>
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
                    <div className="text-xs font-semibold text-gray-700 mb-1">Proteína (g)</div>
                    <div className="text-lg font-bold text-green-700">{formatNumber(stats.totalProtein, locale)}</div>
                  </div>
                  <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-4 border border-blue-200">
                    <div className="text-xs font-semibold text-gray-700 mb-1">Carboidratos (g)</div>
                    <div className="text-lg font-bold text-blue-700">{formatNumber(stats.totalCarbs, locale)}</div>
                  </div>
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border border-purple-200">
                    <div className="text-xs font-semibold text-gray-700 mb-1">Gordura (g)</div>
                    <div className="text-lg font-bold text-purple-700">{formatNumber(stats.totalFat, locale)}</div>
                  </div>
                  <div className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-xl p-4 border border-gray-200">
                    <div className="text-xs font-semibold text-gray-700 mb-1">Média/Dia</div>
                    <div className="text-lg font-bold text-gray-700">{formatNumber(stats.avgCalories, locale)}</div>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="bg-white rounded-xl p-4 border border-orange-200 shadow-sm">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        <div className="font-medium text-gray-700 text-sm">🔥 Calorias</div>
                    ...
                    {goals.calorias && (
                      <div className="h-2 mt-3 bg-gray-200 rounded-full overflow-hidden">
                        <div 
                          ...
                          style={{width: Math.min(100, progress.calories || 0) + '%'}} 
                        />
                      </div>
                    )}
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-4 border border-green-200 shadow-sm">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        <div className="font-medium text-gray-700 text-sm">💪 Proteína</div>
                        <div className="text-xs text-gray-500 mt-1">
                    ...
                    {goals.proteina && (
                      <div className="h-2 mt-3 bg-gray-200 rounded-full overflow-hidden">
                        <div 
                          ...
                          style={{width: Math.min(100, progress.protein_g || 0) + '%'}} 
                        />
                      </div>
                    )}
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-4 border border-blue-200 shadow-sm">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        <div className="font-medium text-gray-700 text-sm">🍞 Carboidratos</div>
                        <div className="text-xs text-gray-500 mt-1">
                    ...
                    {goals.carboidratos && (
                      <div className="h-2 mt-3 bg-gray-200 rounded-full overflow-hidden">
                        <div 
                          ...
                          style={{width: Math.min(100, progress.carbs_g || 0) + '%'}} 
                        />
                      </div>
                    )}
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-4 border border-purple-200 shadow-sm">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        <div className="font-medium text-gray-700 text-sm">🥑 Gordura</div>
                        <div className="text-xs text-gray-500 mt-1">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 font-medium mb-1">Dados insuficientes para estatísticas</p>
                <p className="text-sm text-gray-500">Registre algumas refeições para ver as análises</p>
              </div>
            )}
          </div>
        </Card>

        {/* Histórico modernizado para mobile */}
        <Card className="bg-white border-0 shadow-lg rounded-2xl overflow-hidden">
          <div className="p-5">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="flex-1">
                <h2 className="text-lg font-semibold text-gray-900">Histórico de Refeições</h2>
            ...
            {logs.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 font-medium mb-1">Nenhuma refeição registrada</p>
                <p className="text-sm text-gray-500">Registre sua primeira refeição acima</p>
              </div>
            ) : (
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            <span className="capitalize text-sm font-medium text-gray-700">
                              {t((`meal.type.${mealTypes.includes(log.meal_type as any) ? log.meal_type : 'other'}`) as any)}
                            </span>
                            <span className="text-xs text-gray-500">
                              {new Date(log.log_datetime).toLocaleTimeString(locale === 'pt' ? 'pt-BR' : 'en-US', { hour: '2-digit', minute: '2-digit' })}
                            </span>
                          </div>
                          <p className="text-xs text-gray-600">
                            {formatDateSafe(log.log_datetime, locale)}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="text-center">
                        ...
                        {editingId === log.id ? (
                          ...
                          <div className="font-bold text-orange-700 text-sm">
                            {log.calories != null ? formatNumber(log.calories, locale) : '—'}
                          </div>
                        )}
                      </div>
                      <div className="text-center">
                        ...
                        {editingId === log.id ? (
                          ...
                          <div className="font-bold text-green-700 text-sm">
                            {log.protein_g != null ? formatNumber(+log.protein_g.toFixed(1), locale) : '—'}
                          </div>
                        )}
                      </div>
                      <div className="text-center">
                        ...
                        {editingId === log.id ? (
                          ...
                          <div className="font-bold text-blue-700 text-sm">
                            {log.carbs_g != null ? formatNumber(+log.carbs_g.toFixed(1), locale) : '—'}
                          </div>
                        )}
                      </div>
                      <div className="text-center">
                        ...
                        {editingId === log.id ? (
                          ...
                          <div className="font-bold text-purple-700 text-sm">
                            {log.fat_g != null ? formatNumber(+log.fat_g.toFixed(1), locale) : '—'}
                          </div>
                        )}
                      </div>
                    </div>
      ...
      <ConfirmDialog
        ...
        description={`Tem certeza que deseja excluir esta refeição? ${logs.find(l => l.id === pendingDelete)?.description || ''}`}
