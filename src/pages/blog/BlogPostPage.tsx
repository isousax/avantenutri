...
const BlogPostPage: React.FC = () => {
  ...
  const {
    ...
    enabled: !!slug && !!post, // só busca relacionados quando o post existir
  ...
  const error = postErr || relatedErr ? "Erro ao carregar" : null;
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-25 py-8">
        <SEO
          ...
          image={
            ...
            "https://avantenutri.com.br/logo-social.png"
          }
          imageWidth={1200}
          imageHeight={630}
          breadcrumbItems={[
                  ...
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">
                        {post.author_name || "Avante Nutri"}
                      </p>
                      <p className="text-sm text-gray-500">
                        {publishDate
                          ? `Publicado em ${fmtDate(publishDate, locale, {
                              dateStyle: "long",
                            })}`
                          : null}
                      </p>
                    ...
                    {canPreview && (
                      <span
                        className={`ml-4 text-xs uppercase tracking-wide px-2 py-1 rounded-full ${
